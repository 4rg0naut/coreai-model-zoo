...
_Generated by `scripts/aggregate_bench.py` — do not edit by hand. Last run: 2026-09-20 01:10 UTC._
...
| Device | `qwen3-0.6b` | `qwen3-4b` | `qwen3.5-0.8b` | `qwen3.5-2b` | `minicpm5-1b` | `minicpm5-2b` | `qwen3.6-27b` | `qwen3.8-27b` |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| iPhone 17 (A19, `iPhone18,3`) | — | — | — | — | 59.1\* (n=1) | — | — | — |
| iPhone 17 Pro (A19 Pro, `iPhone18,1`) | — | — | — | — | — | 25.3\* (n=1) | — | — |
| `Mac16,7` | 376.8\* (n=1) | 71.0\* (n=1) | 180.6\* (n=1) | 99.1\* (n=1) | 205.5\* (n=1) | 90.4\* (n=1) | 8.7\* (n=1) | 8.6\* (n=1) |
...
Accepted submissions: **11** · excluded by environment filter: **0** · rejected (schema/protocol): **0**
