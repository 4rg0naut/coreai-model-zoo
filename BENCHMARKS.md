...
_Generated by `scripts/aggregate_bench.py` — do not edit by hand. Last run: 2026-09-20 01:25 UTC._
...
| MacBook Pro 16-inch 2024 (M4 Pro, `Mac16,7`) | 376.8\* (n=1) | 71.0\* (n=1) | 180.6\* (n=1) | 99.1\* (n=1) | 205.5\* (n=1) | 90.4\* (n=1) | 8.7\* (n=1) | 8.6\* (n=1) |
