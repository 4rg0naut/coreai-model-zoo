...
the token mixers are exactly [Qwen3.5](../qwen3.5/README.md) — 40 layers on a 3:1 interleave of
...
- First run downloads the model — 35.0 GB (Mac) — then it loads from the
