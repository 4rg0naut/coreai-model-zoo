...
| [`minicpm5-1b.md`](minicpm5-1b/README.md) | MiniCPM5-1B (plain Llama dense, OpenBMB) | [🤗 MiniCPM5-1B-CoreAI](https://huggingface.co/mlboydaisuke/MiniCPM5-1B-CoreAI) | 1.08B int8 per-block-32 (rebuilt 2026-09-09; the per-channel bundle had dead LM-head rows and never halted); plus `ios-ane-h18p/` — stock static iOS export, **8-bit** palettized (1.3 GB), **Neural Engine**, device gate PASS 3/3 (4-bit fails), same-day A/B p128/g256: 76.8 tok/s decode vs 67.1 / 64.4 on the int8 GPU bundle; 24/24 + stop-exact vs HF fp32 on device, **61.7 tok/s iPhone 17 Pro**, 246.6 tok/s M4 Max (pipelined, llama→mistral remap) |
| [`qwen3-0.6b-official`](qwen3-0.6b-official/README.md) | Qwen3-0.6B, **Apple's official recipe** (no zoo port) — this card records the Neural Engine bundle | [🤗 qwen3-0.6b-CoreAI-official](https://huggingface.co/mlboydaisuke/qwen3-0.6b-CoreAI-official) | `ios-ane-h18p/` = the published `ios/` IR (Apple's mixed 4/8-bit iOS preset) AOT-compiled for the h18p Neural Engine with the GA toolchain, 31/31 ANE regions, 557 MB; **device gate pending** (2026-09-15) |
| [`qwen3-4b-official`](qwen3-4b-official/README.md) | Qwen3-4B, **Apple's official recipe** (no zoo port) — this card records the Neural Engine bundle | [🤗 qwen3-4b-CoreAI-official](https://huggingface.co/mlboydaisuke/qwen3-4b-CoreAI-official) | `ios-ane-h18p/` = the published `ios/` IR (mixed 4/8-bit, group 32) AOT-compiled for the h18p Neural Engine, 31/31 ANE regions, 2.66 GB; **device gate pending** (2026-09-15) |
| [`minicpm5-2b`](minicpm5-2b/README.md) | MiniCPM5-2B (plain Llama dense, 42L, OpenBMB — the 1B recipe one YAML apart: int8 per-block-32) | [🤗 MiniCPM5-2B-CoreAI](https://huggingface.co/mlboydaisuke/MiniCPM5-2B-CoreAI) | 2.5B int8 per-block-32 (2.7 GB), **16/16 token-exact vs HF fp32** (margin-aware gate), **22.4 tok/s iPhone 17 Pro** / 127.6 M4 Max (pipelined, llama→mistral remap); plus `ios-ane-h18p/` — stock static iOS export, 4-bit palettized (1.4 GB), **Neural Engine**, device gate PASS 3/3, same-day A/B p128/g256: 55.4 / 51.5 tok/s decode vs 22.8 / 20.6 on the int8 GPU bundle |
...
| [`granite-embedding-97m`](granite-embedding-97m/README.md) | Granite-Embedding-97M-Multilingual-R2 (ModernBERT encoder, CLS/L2, IBM) — zoo's **smallest embedder + first encoder-architecture one** | [🤗 Granite-Embedding-97M-Multilingual-R2-CoreAI](https://huggingface.co/mlboydaisuke/Granite-Embedding-97M-Multilingual-R2-CoreAI) | 97M fp32, 35/35 vs HF at every stage (layer gate 1e-4, negative controls), **iPhone 17 Pro h18p AOT 5.54 / 20.99 ms (S128/S512), M4 Max JIT 4.14 / 4.89 ms**; w8 305 MB optional (cos 0.99941, not faster); tokenizer gated 1,362/1,362 |
