...
| [**MiniCPM5-2B**](models/minicpm5-2b/README.md) (2B-class on-device LLM, the 1B's 42-layer sibling — hybrid Think/No-Think, tool calling, 128K; released 2026-09-06, OpenBMB) | [🤗 MiniCPM5-2B-CoreAI](https://huggingface.co/mlboydaisuke/MiniCPM5-2B-CoreAI) | [ChatDemo ↗](https://github.com/john-rocky/coreai-kit/tree/main/Examples/ChatDemo) | Apache-2.0 |
