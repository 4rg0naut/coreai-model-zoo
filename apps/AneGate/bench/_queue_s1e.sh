#!/bin/zsh
# S1 queue 6 (18:0x, USB): Qwen 3-arm A/B → 6-bit gate → eq4 → eq8 (ANE 8-bit now cached) → sustained 5-min 2B, 1B → restore.
...
cd $B && $B/_abn.sh qwen qwen3_1_7b_ane,qwen3_1_7b_zoo_iosgpu,qwen3_1_7b_gpu_int4lin 2 128 256 5 20 > /dev/null 2>&1
...
step "restored PipelinedBench; Documents/models: $N"; step "QUEUE6 END"
